...
export const OurFeature = () => {
    return (
        <div>
            <section className="si__our__features__area pt-120 pb-120 custom__width bg" style={{ background: "url('assets/images/features/bg.png')" }}>
                <div className="container">
                    <div className="row align-items-center">
                        <div className="col-lg-5 wow fadeInUp animated" data-wow-delay=".5s">
                            <div className="si__our__features__box">
                                <div className="si__our__features__box__inner">
                                    <div className="si__section__title pb-40">
                                        <h5> oUR features <i className="fa-regular fa-chevrons-right"></i> </h5>
                                        <h1 className="text-white text-anime-style-3"> Building Bridges <br /> <span className="si__section__title__highlight"> Business <svg width="206" height="8" viewBox="0 0 206 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="col-lg-7">
                            <div className="si__our__features__thumb reveal-left">
                                ...
                                <div className="si__our__features__thumb__text">
